...
Full-Stack .NET Developer with 4+ years of experience building secure, scalable applications across fintech, ERP and SaaS in regulated, enterprise environments. Strong in \textbf{.NET 8 / ASP.NET Core} and \textbf{C\#} on the backend and \textbf{Angular (TypeScript)} on the frontend, designing and implementing RESTful APIs, reusable components, and clean, maintainable code. Experienced with \textbf{Entity Framework}, \textbf{SQL Server}, Azure cloud, authentication/authorisation, and unit/integration testing. Comfortable owning features end-to-end in Agile teams, collaborating directly with stakeholders to shape solutions and deliver production-ready software.
...
\begin{resume_list}
    \item \textbf{Frontend:} Angular (up to v16), TypeScript/JavaScript, standalone components, reactive forms, Tailwind CSS, Bootstrap 4
    \item \textbf{Backend (.NET):} C\#, .NET Core / .NET 8, ASP.NET Core Web API \& Minimal APIs, Entity Framework Core/EF 8, LINQ, Dapper, ADO.NET, RESTful API design, SOLID, Clean Architecture, Microservices
    \item \textbf{Cloud \& DevOps:} Microsoft Azure (App Services, Functions, Service Bus, Key Vault, Blob Storage, Redis Cache, Logic Apps, OpenAI Service, SQL Database, AD B2C), Azure DevOps, AWS (EC2, Lambda), CI/CD pipelines, Git/Bitbucket
    \item \textbf{Databases:} Oracle, SQL Server, Azure SQL Database, MySQL, PostgreSQL, MongoDB
    ...
    \item \textbf{Testing \& Automation:} Unit/integration testing (\textbf{xUnit}), Selenium, SoapUI, Swagger, JWT, Postman, Automated Workflows
\end{resume_list}
...
\begin{resume_list}
    \item Architect and develop SaaS product backend for Scholarbot AI homework application using \textbf{.NET 8} and \textbf{ASP.NET Core Minimal APIs}, implementing microservices with \textbf{Entity Framework Core} code-first migrations for scalable multi-tenant data persistence.
    ...
    \item Develop RESTful APIs using \textbf{ASP.NET Core Web API} and \textbf{Dapper ORM} for high-performance data access, implementing authentication/authorisation with \textbf{Azure AD B2C} and API versioning strategies.
    ...
    \item Write unit and integration tests for critical APIs using \textbf{xUnit}, and participate in code reviews to ensure clean, secure, and maintainable code.
\end{resume_list}
...
\begin{resume_list}
    ...
    \item Developed ERP modules (Accounting, Inventory, HR, Invoicing, Smart Reporting) with \textbf{Angular} (TypeScript) and \textbf{SQL Server}, streamlining operations and improving reliability by 30\%.
