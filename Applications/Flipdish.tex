...
Analytics Engineer with 3+ years of experience in data modeling, advanced SQL analytics, and self-serve reporting solutions for financial services and fintech applications. Expert in DBT, Looker, Metabase, and data pipeline architecture. Experienced in creating KPIs, dashboards, and data quality monitoring processes. Passionate about enabling data-driven decision making through scalable analytics solutions.
...
\begin{resume_list}
    ...
    \item \textbf{Analytics Engineering \& Data Science:} DBT, Looker, LookML, Metabase, Python, R, pandas, NumPy, scikit-learn, TensorFlow, statistical modeling, machine learning, predictive analytics, time series analysis, regression analysis, data visualization, Power BI, Tableau, data quality monitoring
    ...
    \item \textbf{Databases \& Data Engineering:} Oracle, SQL Server, MySQL, PostgreSQL, MongoDB, data modeling, ETL/ELT pipelines, data warehousing
    \item \textbf{Tools \& Technologies:} Git, Bitbucket, Power BI, SOAP/REST, RabbitMQ, ISO-8583 Messaging, GitHub, data pipeline orchestration, version control
...
\begin{resume_list}
    ...
    \item Designed and implemented \textbf{end-to-end analytics pipeline} using \textbf{DBT}, \textbf{Python}, and \textbf{scikit-learn} for fraud detection, creating \textbf{reusable data models} and \textbf{self-serve dashboards} that achieved 95\% accuracy while reducing false positives by 30\%.
    \item Built \textbf{self-serve analytics dashboards} using \textbf{Looker} and \textbf{Metabase} for payment success rate analysis, enabling stakeholders to answer critical business questions independently and improving merchant onboarding decisions by 25\%.
    ...
    \item Developed \textbf{data quality monitoring} processes using \textbf{Python} and \textbf{SQL}, implementing automated data validation and alerting systems that reduced data inconsistencies by 60\% and improved reporting accuracy.
...
\begin{resume_list}
    ...
    \item Architected \textbf{data models from scratch} using \textbf{DBT} and \textbf{SQL Server} for ERP modules (Accounting, Inventory, HR, Invoicing, Smart Reporting), creating \textbf{KPIs} and \textbf{self-serve reporting solutions} that streamlined operations and improved reliability by 30\%.
    \item Leveraged \textbf{Generative AI} and \textbf{machine learning} to automate invoice creation and \textbf{predictive analytics} for billing accuracy, improving decision-making by 20\% and enabling \textbf{data-driven business insights}.
    \item Created \textbf{comprehensive analytics solutions} using \textbf{Looker}, \textbf{Power BI}, and \textbf{advanced SQL} for auto dealers, building \textbf{reusable data models} and \textbf{dashboards} that identified customer churn patterns and increased retention by 20\%.
    \item Developed \textbf{regression models} for inventory optimization using \textbf{Python pandas} and \textbf{NumPy}, reducing stock costs by 15\%.
...
\begin{itemize}
    ...
    \item \textbf{Analytics Engineering Pipeline (DBT, Looker, SQL Server, Python):} Built comprehensive data models and self-serve analytics solution for credit risk assessment, creating reusable DBT transformations and Looker dashboards that enabled stakeholders to generate insights independently, reducing ad-hoc requests by 70\% and achieving 85\% accuracy in risk assessment.
    \item \textbf{Self-Serve Customer Analytics Platform (Metabase, DBT, Python, SQL):} Designed end-to-end analytics solution with data quality monitoring, creating reusable data models and interactive dashboards that enabled business stakeholders to identify at-risk customers independently, reducing churn by 25\% and ad-hoc analytics requests by 60\%.
    \item \textbf{Enterprise Analytics Platform (.NET Core, DBT, Looker, SQL Server, Azure):} Architected comprehensive analytics solution for multi-tenant SaaS ERP, building data models from scratch using DBT and creating self-serve dashboards with Looker. Implemented data quality monitoring and KPI tracking across Accounting, Inventory, HR, and Invoicing modules, reducing errors by 80\% and enabling data-driven decision making across all business functions.
