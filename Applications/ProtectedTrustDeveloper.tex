...
\begin{resume_list}
    \item \textbf{Programming \& Frameworks:} C\#, .NET Core, ASP.NET Core, .NET 6/.NET 8, Angular 16, JavaScript, jQuery, Ajax, RESTful APIs, Microservices, WCF, Python, Entity Framework 8, ASP.NET MVC, Dapper, ADO.NET, Clean Architecture, WebAPI (REST/SOAP), Multithreading, LINQ, SOLID Principles
    ...
    \item \textbf{Tools \& Technologies:} Git, Bitbucket, VSTS, GitLab, JIRA, Power BI, SOAP/REST, RabbitMQ, ISO-8583 Messaging
    \item \textbf{Testing \& Automation:} Selenium, SoapUI, Unit Testing, Integration Testing, Test-Driven Development, Swagger, JWT, Postman, Automated Workflows
\end{resume_list}
...
\begin{resume_list}
    ...
    \item Participated in peer code reviews and established best practices for maintainable, scalable code, improving code quality and reducing technical debt.
\end{resume_list}

\headingBf{One Technology Services}{Jun 2022 -- Oct 2023}
\headingIt{Full-Stack .NET Developer \hfill Remote, USA}{}
\begin{resume_list}
    \item Delivered multi-tenant SaaS ERP on Azure with service-based architecture, reducing authorization errors by 80\% and improving uptime.
...
\begin{resume_list}
    ...
    \item Implemented Test-Driven Development practices and automated testing strategies, ensuring high code quality and system reliability.
\end{resume_list}
