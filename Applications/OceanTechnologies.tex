...
\begin{resume_list}
    \item \textbf{Programming \& Frameworks:} C\#, .NET Core, ASP.NET Core, .NET 8, OOP, Angular 16, JavaScript, Python, RESTful APIs, Microservices, Distributed Systems, Asynchronous Programming, Client-Server Architecture, Entity Framework 8, ASP.NET MVC, Dapper, ADO.NET, Clean Architecture, WebAPI (REST/SOAP), Multithreading, LINQ, SOLID Principles
    \item \textbf{Cloud \& DevOps:} Microsoft Azure (Functions, Service Bus, App Services, Key Vault, Blob Storage, Redis Cache), Azure DevOps, AWS (EC2, Lambda), Docker, CI/CD Pipelines, Agile/DevOps Practices, Performance Tuning, Monitoring
    \item \textbf{Databases:} SQL (SQL Server, PostgreSQL, MySQL), NoSQL (MongoDB), Oracle
    \item \textbf{Tools \& Technologies:} Git, Bitbucket, Swagger/OpenAPI, Postman, SOAP/REST, RabbitMQ (Message Queues), Power BI, ISO-8583 Messaging, Documentation, Code Reviews
    \item \textbf{Testing \& Automation:} Test-Driven Development (TDD), Unit \& Integration Testing, Functional Testing, Selenium, SoapUI, JWT, Automated Workflows
\end{resume_list}
...
\begin{resume_list}
    \item Implemented transaction validation and encryption modules in an SOA/microservices-based Etisalat Payment Gateway using C\#, enhancing security and reducing processing errors by 50\% for Gulf merchants.
    ...
    \item Streamlined Oracle operations and introduced Bitbucket Server workflows and CI/CD pipelines, improving team deployment efficiency by 25\%.
\end{resume_list}

\headingBf{One Technology Services}{Jun 2022 -- Oct 2023}
\headingIt{Full-Stack .NET Developer \hfill Remote, USA}{}
\begin{resume_list}
    \item Delivered multi-tenant SaaS ERP on Azure using microservices/Functions and REST APIs, reducing authorization errors by 80\% and improving uptime.
    \item Led full-stack development across 5 ERP modules, completing the project 2 months ahead of schedule; collaborated in Agile sprints, performed code reviews, and maintained documentation.
...
\begin{resume_list}
    \item Developed VISA PRA Mandate transaction APIs leveraging asynchronous processing, improving transaction speed and accuracy, contributing to an estimated \$50,000 annual revenue increase.
    \item Delivered EKPCMS for HBL using .NET and C++, reducing call handling time by 30\% and improving service efficiency.
    \item Managed POS, debit/credit, credit advice, and ATM transactions; optimized VISA and MasterCard integration and system performance to boost success rates by 30\%.
