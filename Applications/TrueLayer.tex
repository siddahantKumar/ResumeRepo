...
Full-Stack Software Engineer with 3+ years of experience designing and building high-performance web applications, SaaS platforms, and \textbf{payment solutions}. Skilled in C\#, .NET Core, \textbf{gRPC}, \textbf{protocol buffers}, and \textbf{cloud technologies}. Experienced in \textbf{fintech systems}, \textbf{payment gateways}, and \textbf{financial data integration}. Passionate about building \textbf{scalable payment infrastructure} and \textbf{open banking solutions} that revolutionize online payments.
...
\begin{resume_list}
    \item \textbf{Programming \& Frameworks:} C\#, .NET Core, .NET 8, Angular 16, Tailwind CSS, Bootstrap 4, RESTful APIs, Microservices, WCF, JavaScript, Python, Entity Framework 8, ASP.NET MVC, Dapper, ADO.NET, Clean Architecture, WebAPI (REST/SOAP), Multithreading, LINQ, SOLID Principles, \textbf{gRPC}, \textbf{Protocol Buffers}
    ...
    \item \textbf{Fintech \& Payment Systems:} \textbf{Payment Gateways}, \textbf{Financial Data Integration}, \textbf{Open Banking}, \textbf{Transaction Processing}, \textbf{Payment Security}, \textbf{EMV Integration}, \textbf{Card Management Systems}, \textbf{ISO-8583 Messaging}
\end{resume_list}
...
\begin{resume_list}
    \item Implemented \textbf{gRPC services} and \textbf{protocol buffers} for high-performance payment processing, enabling efficient inter-service communication and reducing latency by 30\% in transaction processing.
    \item Deployed payment gateway services using \textbf{Kubernetes} orchestration, implementing \textbf{containerization} and \textbf{scalable infrastructure} to handle high-volume transaction processing.
...
\begin{resume_list}
    ...
    \item Established \textbf{monitoring and alerting} using \textbf{Prometheus} and \textbf{Grafana} for SaaS platform observability, ensuring 99.9\% uptime and rapid incident response.
...
\begin{resume_list}
    \item Contributed to \textbf{open source projects} and built \textbf{reusable libraries} for API development, sharing knowledge with the developer community and improving code quality standards.
