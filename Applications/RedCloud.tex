...
Full-Stack .NET Developer with 3+ years of experience delivering secure, scalable B2B commerce, FinTech, and ERP solutions. Expert in C\#, .NET Core, Node.js, REST APIs, AWS, and microservices architecture. Proven record of reducing deployment times by 40\% and achieving 99.9\% transaction success rates. Skilled in payment gateways, eCommerce platforms, and CI/CD pipelines.
...
\begin{resume_list}
    \item \textbf{Programming \& Frameworks:} C\#, .NET Core, ASP.NET Core, .NET 8, Node.js, Angular 16, JavaScript, Python, RESTful APIs, Microservices, WCF, Entity Framework 8, ASP.NET MVC, Dapper, ADO.NET, Clean Architecture, WebAPI (REST/SOAP), Multithreading, LINQ, SOLID Principles
    ...
    \item \textbf{Tools \& Technologies:} Git, Bitbucket, Power BI, SOAP/REST, RabbitMQ, ISO-8583 Messaging, Architecture Design, Feature Estimation, Code Reviews
...
\begin{resume_list}
    ...
    \item Conducted code reviews and feature estimation for complex payment gateway integrations, ensuring high-quality deliverables and accurate project timelines.
\end{resume_list}
...
\begin{resume_list}
    ...
    \item Designed system architecture and refined feature requirements for B2B commerce solutions, enabling scalable platform growth.
    ...
    \item Resolved production outages and complex system issues in high-traffic environments, maintaining 99.9\% uptime for critical business operations.
...
\begin{resume_list}
    \item Built and optimized REST APIs for high-traffic B2B commerce systems, improving response times by up to 20\% and reducing page load by 2 seconds through SQL query tuning.
    ...
    \item Collaborated with Engineering and Product Managers to define technical architecture and document system requirements for scalable eCommerce solutions.
\end{resume_list}
