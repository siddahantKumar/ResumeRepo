...
\begin{center}
\textbf{Application Developer | Full-Stack .NET Developer}
\end{center}

Application Developer with 3+ years of experience delivering secure, scalable business solutions, data warehouse systems, and cloud platforms. Expert in C\#, .NET Core, REST APIs, Azure, and enterprise data architecture. Proven record of reducing deployment times by 40\% and achieving high transaction success rates. Skilled in system architecture, data warehouse solutions, and CI/CD pipelines.
...
\begin{resume_list}
    \item \textbf{Programming \& Frameworks:} C\#, .NET Core, ASP.NET Core, .NET 8, Angular 16, JavaScript, TypeScript, Python, RESTful APIs, Web APIs, Microservices, WCF, Entity Framework 8, ASP.NET MVC, Dapper, ADO.NET, Clean Architecture, WebAPI (REST/SOAP), Multithreading, LINQ, SOLID Principles
    \item \textbf{Cloud \& DevOps:} Microsoft Azure (Functions, Service Bus, App Services, Key Vault, Blob Storage, Redis Cache), Azure DevOps, AWS (EC2, Lambda), Databricks, Snowflake, CI/CD Pipelines
    \item \textbf{Databases:} Oracle, SQL Server, MySQL, PostgreSQL, MongoDB
    \item \textbf{Tools \& Technologies:} Git, Bitbucket, JIRA, Confluence, Teams, Power BI, SOAP/REST, RabbitMQ, ISO-8583 Messaging, System Architecture
    \item \textbf{Testing \& Automation:} Selenium, SoapUI, Unit Testing, Swagger, JWT, Postman, Automated Workflows, Agile Development
\end{resume_list}
...
\begin{resume_list}
    \item Designed and developed transaction validation and encryption modules in the SOA-based Etisalat Payment Gateway using C\# and .NET Core, enhancing security and reducing processing errors by 50\% for Gulf merchants.
    ...
    \item Collaborated in Agile development processes and delivered to time-sensitive release schedules, ensuring code quality through best practices and comprehensive technical documentation.
\end{resume_list}

\headingBf{One Technology Services}{Jun 2022 -- Oct 2023}
\headingIt{Full-Stack .NET Developer \hfill Remote, USA}{}
\begin{resume_list}
    \item Designed and delivered multi-tenant SaaS ERP on Azure with enterprise data architecture, reducing authorization errors by 80\% and improving uptime.
    \item Led full-stack development across 5 ERP modules, completing the project 2 months ahead of schedule.
    \item Partnered with business stakeholders and IT delivery teams to gather requirements and produce technical specifications for scalable business solutions.
    ...
    \item Collaborated closely with technology teams to coordinate interdependencies, resolve issues, and understand application overlaps in enterprise environments.
...
\begin{resume_list}
    \item Developed and optimized REST APIs and Web APIs with SQL Server integration, improving response times by up to 20\% and reducing page load by 2 seconds through query optimization.
    ...
    \item Resolved complex technical issues and provided ongoing change management including training and documentation updates for enterprise systems.
\end{resume_list}
