...
Senior Full-Stack .NET Developer with 3+ years of experience delivering secure, scalable ERP systems, FinTech solutions, and cloud platforms. Expert in C\#, .NET Core, REST APIs, Azure, and microservices architecture. Proven record of reducing deployment times by 40\% and achieving 99.9\% transaction success rates. Skilled in project leadership, technical mentoring, and CI/CD pipelines.
...
\begin{resume_list}
    \item \textbf{Programming \& Frameworks:} C\#, .NET Core, ASP.NET Core, .NET 8, Angular 16, JavaScript, TypeScript, Python, RESTful APIs, Microservices, WCF, Entity Framework 8, ASP.NET MVC, Dapper, ADO.NET, Clean Architecture, WebAPI (REST/SOAP), Multithreading, LINQ, SOLID Principles
    \item \textbf{Cloud \& DevOps:} Microsoft Azure (Functions, Service Bus, App Services, Key Vault, Blob Storage, Redis Cache), Azure DevOps, AWS (EC2, Lambda), CI/CD Pipelines, Power Platform
    \item \textbf{Databases:} Oracle, SQL Server, MySQL, PostgreSQL, MongoDB
    \item \textbf{Tools \& Technologies:} Git, Bitbucket, Power BI, Power Automate, SOAP/REST, RabbitMQ, ISO-8583 Messaging, Technical Documentation, Project Leadership
    \item \textbf{Testing \& Automation:} Selenium, SoapUI, Unit Testing, Swagger, JWT, Postman, Automated Workflows, Code Reviews, Technical Mentoring
\end{resume_list}
...
\begin{resume_list}
    \item Led the design and implementation of transaction validation and encryption modules in the SOA-based Etisalat Payment Gateway using C\#, enhancing security and reducing processing errors by 50\% for Gulf merchants.
    ...
    \item Led Agile development processes and provided technical mentoring to junior developers, ensuring code quality through best practices and comprehensive documentation.
\end{resume_list}

\headingBf{One Technology Services}{Jun 2022 -- Oct 2023}
\headingIt{Full-Stack .NET Developer \hfill Remote, USA}{}
\begin{resume_list}
    \item Led the design and delivery of multi-tenant SaaS ERP on Azure with extensible architecture, reducing authorization errors by 80\% and improving uptime.
    \item Led full-stack development across 5 ERP modules, completing the project 2 months ahead of schedule.
    \item Led requirements gathering and stakeholder analysis, producing comprehensive functional specifications and technical designs for scalable ERP solutions.
    ...
    \item Provided technical mentoring and guidance to junior and mid-level developers, sharing expertise to elevate team capability and ensure maintainable code design.
...
\begin{resume_list}
    \item Led the development and optimization of REST APIs with SQL Server integration, improving response times by up to 20\% and reducing page load by 2 seconds through query optimization.
    ...
    \item Resolved complex technical issues and reduced technical debt through systematic problem-solving, providing architectural improvements for enterprise systems.
\end{resume_list}
